...
const EMPTY = { patient_id: '', record_date: '', symptoms: '', diagnosis: '', treatment: '', notes: '' };
        ...
        <Modal title={editing === 'new' ? 'New Medical Record' : 'Edit Medical Record'} onClose={() => setEditing(null)}>
          <form onSubmit={save}>
            <div className="form-grid">
              ...
              <div className="full"><label>Record date *</label>
                <input type="date" value={form.record_date} required onChange={set('record_date')} /></div>
